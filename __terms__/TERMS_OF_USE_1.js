export default `
    ...
    We reserve our right, at our sole discretion, to change, modify, add or remove portions of these Terms, at any time. It is Your responsibility to check these Terms of Use periodically for changes. Your continued use the Wallet/of the Website following the posting of changes will mean that you accept and agree to the changes.
    ...
    https://trustee.deals (“Website”) is the website  which displays information about the Wallet.
    Support: https://t.me/trustee_wallet  
    
    
    Trustee Wallet  (“Wallet”) is a software program that stores private and public keys (in pairs), provide interactions with various blockchain to enable You to send and receive Virtual currency,  perform transaction with Virtual currency, monitor Yours balance and conduct other operations. 
    ...
    a) permits You to self-custody Virtual Currency;
    ...
    “Virtual Currency" means a cryptocurrency, digital currency, digital asset, cryptoassets or other such similar term describing, for example, Bitcoin or Ether.
      
    “You” are an individual or a legal entity that uses the Wallet  for yours  own purposes.
    
    
    “Fiat money”  means currency issued by the government, is designated a legal tender on the legislative level in the country of issuance and is suitable for exchange to each other. 
      
    I. Time of entry into force:
    1. As soon as You tick the box “Agree and Continue”, the Terms will enter into force. By ticking the box, You certify that You have read and agreed with these Terms and Privacy Policy as well.
     
    II. Legal status:
    1. We are not an exchange, store, financial or funding institution. 
    2. We do not have any access to Yours Virtual Currency, bank accounts, bank cards, private keys,  passwords etc.  
    3. We do not execute any control over  Yours transactions or/and Your activity.  
    ...
    2. Any such changes will be effective upon the posting on the application and/ or on Website. The effective date which is at the top of the Terms informs You about the latest version of the Terms.
    ...
    1.When you create a Wallet, the Wallet software generates a cryptographic private and public key pair that You may use to operate any supported Virtual Currency via the relevant Virtual Currency network.  
     2. You are solely responsible for safekeeping  mnemonic (seed) phrase associated with your Wallet.
    ...
    V. Procedure of using the Wallet:
    1. The Wallet allows You to self-custody Virtual Currency. 
    2. The Wallet implements integration with third parties to allow You to perform Transaction with Virtual Currency. 
    3. The Wallet  implements integration with third parties to allow You to perform Transaction between Virtual Currency and Fiat Money. 
    ...
    1) You have the legal right to use any bank card(s) or other payment method(s) in connection with any Transaction; and 
    2) the information You supply to Us is true, correct and complete.
    By submitting such information, You grant Us the right to provide the information to third parties for purposes of fulfilment of Transaction.
    ...
    i) violation of the rights of third parties as a result of the Yours actions committed while using the Wallet.
    ...
    1. Your access to or use of or inability to access or use the Wallet; 
    2. any conduct or content of any third party on the Wallet; 
    3. any content obtained from the Wallet; and 
    4. unauthorized access, use or alteration of Your transmissions or content, whether based on warranty, contract, whether or not we have been informed of the possibility of such damage, and even if a remedy set forth herein is found to have failed of its essential purpose.
