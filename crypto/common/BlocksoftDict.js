...
const VisibleCodes = [
    'WAVES', 'WAVES_USDN' // CASHBACK', 'NFT', 'BTC', 'ETH', 'TRX', 'TRX_USDT', 'BNB_SMART', 'MATIC' // add code here to show on start screen
]
const Codes = [
    'WAVES', 'WAVES_USDN' // CASHBACK', 'NFT', 'BTC', 'ETH', 'USDT', 'LTC', 'ETH_USDT', 'TRX', 'TRX_USDT', 'BNB', 'BNB_SMART', 'MATIC', 'ETH_TRUE_USD', 'ETH_BNB', 'ETH_USDC', 'ETH_PAX', 'ETH_DAI', 'FIO'   // add code here for autocreation the wallet address with the currency
]
