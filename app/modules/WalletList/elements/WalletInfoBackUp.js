                ...
                <View style={{ backgroundColor: '#fff' }}>
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.btn}>
                            <ButtonIcon style={{ marginBottom: 10 }} icon={'QR_CODE_BTN'} callback={() => this.handleScanQr()} />
                            {/*<ToolTips type={'HOME_SCREEN_QR_BTN_TIP'}*/}
                            {/*          height={140}*/}
                            {/*          MainComponent={ButtonIcon}*/}
                            {/*          mainComponentProps={{ style: { }, icon: 'QR_CODE_BTN', callback: () =>  }} />*/}
                        </View>
                    </View>
                </View>
                <View>
