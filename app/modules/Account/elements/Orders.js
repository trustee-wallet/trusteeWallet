/**
 * @version 0.9
 * @misha plz recheck if wee need fiat here
 */
...
class Orders extends Component {
    ...
    render() {
        ...
        let tmpExchangeOrders = exchangeOrders ? JSON.parse(JSON.stringify(exchangeOrders)) : {}
        tmpExchangeOrders = tmpExchangeOrders.filter(item => item.requestedInAmount.currencyCode === this.props.cryptoCurrency.currencyCode || item.requestedOutAmount.currencyCode === this.props.cryptoCurrency.currencyCode)
                                                    ...
                                                    <View style={{ flex: 1 }}>
                                                        <View style={styles.transaction__item__content}>
                                                            ...
                                                            <Text style={[styles.transaction__expand, styles.textAlign_right]}>
                                                                - {item.requestedInAmount.amount} {this.props.cryptoCurrency.currencySymbol.toUpperCase()}
                                                            </Text>
                                                        </View>
                                                        <View style={styles.transaction__item__content}>
                                                ...
                                                <View style={{ flex: 1 }}>
                                                    <View style={styles.transaction__item__content}>
                                                        ...
                                                        <Text style={[styles.transaction__income, styles.textAlign_right, { flex: 1 }]}>
                                                            + {item.requestedOutAmount.amount} {this.props.cryptoCurrency.currencySymbol.toUpperCase()}
                                                        </Text>
                                                    </View>
                                                    <View style={styles.transaction__item__content}>
                                                        <Text style={[styles.transaction__subtext, styles.textAlign_right, styles.transaction__subtext_status, { flex: 1, marginRight: 5 }]} numberOfLines={1}>
                                            ...
                                            <View style={[styles.transaction__item]}>
                                                ...
                                                <View style={{ flex: 1 }}>
                                                    <View style={styles.transaction__item__content}>
                                                        ...
                                                        <Text style={[styles.transaction__income, styles.textAlign_right, { flex: 1 }]}>
                                                            {item.requestedInAmount.currencyCode === this.props.cryptoCurrency.currencyCode ? item.requestedInAmount.amount : item.requestedOutAmount.amount}
                                                            {' ' + this.props.cryptoCurrency.currencySymbol.toUpperCase()}
                                                        </Text>
                                                    </View>
                                                    <View style={styles.transaction__item__content}>
                                                        <Text style={[styles.transaction__subtext, styles.textAlign_right, styles.transaction__subtext_status, { flex: 1, marginRight: 5 }]} numberOfLines={1}>
                                                        ...
                                                        <Text style={{ ...styles.transaction__subtext, ...styles.textAlign_right }}>
                                                            {item.requestedOutAmount.currencyCode === this.props.cryptoCurrency.currencyCode ? item.requestedInAmount.amount : item.requestedOutAmount.amount}
                                                            {' ' + BlocksoftDict.getCurrencyAllSettings(item.requestedOutAmount.currencyCode === this.props.cryptoCurrency.currencyCode ? item.requestedInAmount.currencyCode : item.requestedOutAmount.currencyCode).currencySymbol}
                                                        </Text>
                                                    </View>
                                                </View>
                                            </View>
