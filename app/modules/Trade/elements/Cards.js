...
class Cards extends Component {
    ...
    validateCard = async (photoSource) => {
        try {
            ...
            Log.log('Card.validateCard selectedCard.final ' + cardNumber)
            ...
            this.setState({
                ...
                try {
                    ...
                    if (
                        (typeof res.message !== 'undefined' && res.message.includes('Card has not been verified'))
                        || (typeof res.errorMsg !== 'undefined' && res.errorMsg.includes('No file was uploaded'))
                    ) {
                        this.setState({
                            cards: tmpCards,
                            firstItem: selectedCardIndex
