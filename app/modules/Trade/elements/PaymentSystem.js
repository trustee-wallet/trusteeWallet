        ...
        try {
            ...
            for(const paymentSystem of paymentSystemListTmp){
                paymentSystemList.push({
                    ...
                    available: paymentSystem.supportedCountries.indexOf(selectedFiatCurrency.iso.toString()) !== -1,
                    limits: paymentSystem.limits
                })
            }
        ...
        switch(item.paymentSystem){
            ...
            case "MOBILE_PHONE":
                ...
                Icon = () => <View style={[styles.paymentSystem__medium, { flex: 1, justifyContent: 'space-between' }]}>
                    <KievStar fill={ ifSelectStyle ? '#fff' : '#0095db'} />
                    <Vodafone fill={ ifSelectStyle ? '#fff' : '#e60000'} subFill={ ifSelectStyle ? '#e60000' : '#fff'} />
                    <Lifecell fill={ ifSelectStyle ? '#fff' : '#244f9a'} />
                </View>
                break
            default:
                title = ''
