            ...
            <View style={{ paddingLeft: 15, paddingTop: 15, position: 'relative'}}>
                {
                    isPhotoValidation && needValidation ?
                        <TouchableOpacity style={{
                            ...
                            zIndex: 30
                        }} onPress={() => validateCard()} disabled={card.uniqueParams != null || card.uniqueParams === false}>
                            <View style={{
                                alignItems: 'center',
                                ...
                                { card.uniqueParams == null ? <MaterialIcons size={16} color="#7127ac" name="add-a-photo" /> : card.uniqueParams === false && Platform.OS === 'ios' ? <UIActivityIndicator size={16} color='#7127ac' /> : card.uniqueParams === false && Platform.OS === 'android' ? <MaterialIndicator size={16} color='#7127ac' /> : <Ionicons size={25} color="#7127ac" name="ios-checkmark" /> }
                            </View>
                            ...
                            <View style={{ flex: 1, position: 'relative' }}>
                                ...
                                <View>
                                    <Text style={styles.slide__card__name}>
                                        { card.card_name === null || card.card_name === '' ? (strings('card.noName')).toUpperCase() : (card.card_name).toUpperCase() } {'| ' + country.country }
                                    </Text>
