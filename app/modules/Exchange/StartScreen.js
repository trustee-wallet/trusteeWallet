...
class MainDataScreen extends Component {
    ...
    constructor() {
        super()
        this.state = {
            source: `https://changenow.io/${i18n.locale.split("-")[0]}/exchange?amount=1&from=btc&link_id=35bd08f188a35c&to=eth`,
    ...
    createNewOrder = () => {
        ...
        {
            exchangeMainDataScreenParam: {
                url: `https://changenow.io/${i18n.locale.split("-")[0]}/exchange?amount=1&from=btc&link_id=35bd08f188a35c&to=eth`,
                type: "CREATE_NEW_ORDER"
            }
        })
    }
    ...
    selectOrder = (item) => {
        NavStore.goNext("MainDataScreen",
            {
                exchangeMainDataScreenParam: {
                    url: `https://changenow.io/${i18n.locale.split("-")[0]}/exchange/txs/${item.id}`,
                    type: "VIEW_ORDER"
                }
            })
    }
