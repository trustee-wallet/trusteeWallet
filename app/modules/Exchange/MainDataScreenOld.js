...
class MainDataScreen extends Component {
    ...
    handleGetExchangeWay = (selectedInCryptocurrency, selectedOutCryptocurrency) => {
        ...
        try {
            ...
            exchangeWays = exchangeWays.filter(item => {

                if(item[extendsFields.inCryptocurrency] === selectedInCryptocurrency.currencyCode && item[extendsFields.outCryptocurrency] === selectedOutCryptocurrency.currencyCode){
                    return item
                }
            })
