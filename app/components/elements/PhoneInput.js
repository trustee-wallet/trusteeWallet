...
class PhoneInput extends Component {
    ...
    validate = (phoneCodeList) => {
        this.setState({
            isValid: this.refPhone.isValidNumber()
        })

        const countryCode = this.refPhone.getCountryCode()

        if (typeof phoneCodeList !== 'undefined' && !phoneCodeList.includes(+countryCode)) {
            throw new Error(strings('tradeScreen.modalError.notSupported'))
        }
    ...
    onChangeText = (value) => {
        ...
        this.setState({
            ...
            let phoneMask = '+999999999999999999'
